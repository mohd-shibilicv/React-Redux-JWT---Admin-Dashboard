      ...
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div className="flex items-center lg:order-2">
            ...
            <Link
              to="/signup"
              className="text-black flex justify-between gap-2 items-center bg-primary-700 hover:bg-gray-200 delay-150 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none"
            >
              Get started
          ...
          <div
            className={`${isMenuOpen ? "" : "hidden" } justify-between items-center w-full lg:flex lg:w-auto lg:order-1`}
            id="mobile-menu-2"
          >
